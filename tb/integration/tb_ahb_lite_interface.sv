...
module tb_ahb_lite_interface;
    ...
    initial begin
        ...
        wait (dut.core.id_regfile.regs[9] == 32'h0000_0124);
        repeat (4) @(posedge clk);
        #1;

        if (dut.core.id_regfile.regs[5] !== 32'h0000_007f ||
            dut.core.id_regfile.regs[7] !== 32'h0000_0123 ||
            dut.core.id_regfile.regs[8] !== 32'h0000_0123)
