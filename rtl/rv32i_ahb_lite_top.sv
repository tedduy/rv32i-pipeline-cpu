...
module rv32i_top #(
    ...
    native_to_ahb_lite #(
        ...
        .i_native_valid(imem_valid), .i_native_write(1'b0),
        ...
        .o_hmastlock(o_iahb_hmastlock), .o_hwdata(o_iahb_hwdata),
        .i_hrdata(i_iahb_hrdata), .i_hready(i_iahb_hready),
    ...
    native_to_ahb_lite #(
        ...
        .i_clk(i_clk), .i_arst_n(i_arst_n),
        .i_native_valid(dmem_valid), .i_native_write(dmem_write),
        .i_native_addr(dmem_addr), .i_native_wdata(dmem_wdata),
        ...
        .o_hmastlock(o_dahb_hmastlock), .o_hwdata(o_dahb_hwdata),
        .i_hrdata(i_dahb_hrdata), .i_hready(i_dahb_hready),
