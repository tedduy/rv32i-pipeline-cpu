  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  {
    int Cycles = User_Time;
    int Dhrystones_Per_MHz = (Number_Of_Runs * 1000000) / Cycles;
    int DMIPS_x1000 = (Dhrystones_Per_MHz * 1000) / 1757;
    printf ("Total CPU Cycles:                           %d \n", Cycles);
    printf ("Dhrystones per MHz:                         %d \n", Dhrystones_Per_MHz);
    printf ("DMIPS/MHz (x1000):                          %d \n", DMIPS_x1000);
    printf ("\n");
  }
#endif
